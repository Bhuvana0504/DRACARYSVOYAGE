...
public class DracarysVoyage extends JPanel implements ActionListener,KeyListener{
    ...
    DracarysVoyage() {
        ...
        try {
            ...
            topPipeImg = new ImageIcon(getClass().getResource("/Images/topfire.png")).getImage();
            bottomPipeImg = new ImageIcon(getClass().getResource("/Images/bottomfire.jpg")).getImage();
        } catch (Exception e) {
